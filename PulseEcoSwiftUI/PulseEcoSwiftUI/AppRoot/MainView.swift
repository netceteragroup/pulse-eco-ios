...
struct MainView: View {
    ...
    var body: some View {
        LoadingView(isShowing: .constant(self.dataSource.loadingCityData),
                    loadingMeasures: .constant(self.dataSource.loadingMeasures)) {
                        NavigationView {
                            ZStack{
                                VStack(alignment: .center) {
                                    MeasureListView(viewModel: MeasureListVM(
                                        selectedMeasure: self.appVM.selectedMeasure,
